...
class _HomePageState extends State<HomePage> {
  ...
  static final List<String> chartDropdownItems = [ 'Last month', 'Last 6 month', 'Last year' ];
                  ...
                  (
                    ...
                    [
                      Column
                        ...
                        children: <Widget>
                        [
                          Text('Total Savings', style: TextStyle(color: Colors.blueAccent)),
                          Text('26500 DKK', style: TextStyle(color: Colors.black, fontWeight: FontWeight.w700, fontSize: 28.0))
                        ],
                      ),
                      Material
                        (
                ...
                child: Column
                  (
                    ...
                    [
                      ...
                      Text('Mortgage', style: TextStyle(color: Colors.black, fontWeight: FontWeight.w700, fontSize: 24.0)),
                      Text('Fixed, Floating', style: TextStyle(color: Colors.black45)),
                    ]
                ),
              ),
            ),
